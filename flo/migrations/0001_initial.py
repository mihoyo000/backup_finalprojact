        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=100, unique=True, verbose_name="FAQ 카테고리명"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        related_name="liked_study_post_posts",
                        to=settings.AUTH_USER_MODEL,
                        verbose_name="추천수",
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=0, help_text="표시 순서 (낮을수록 먼저)"
                    ),
                ),
                (
                    "category",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="study_post_comments",
                        to=settings.AUTH_USER_MODEL,
                        verbose_name="댓글 작성자",
                    ),
                ),
